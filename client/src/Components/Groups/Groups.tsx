...
import { userGroups, setUserGroups, setCurrentGroup } from "../../stores/groupStore";
...
// }
// const handleUrl = (groupId: string): string => {
...
function SingleGroupCard(props: any){
    ...
    const handleClick = (event: any, groupInfo: any) => {
        ...
        setCurrentGroup({groupId: groupInfo.groupId});
        ...
        props.navigate(`/Groups/${groupInfo.groupId}`);
    }
